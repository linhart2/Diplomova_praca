...
public class LoggedLevel_4_2 : MonoBehaviour, UnityEngine.EventSystems.IHasChanged
{
    ...
    void generator_uloh()
    {
        ...
        while (moznosti.Count < 14)
        {
            ...
            if (moznosti.Contains(x) == false && x != int.Parse(_examArray[_poliaKtoreSaNevykreslia[0]]) && x != int.Parse(_examArray[_poliaKtoreSaNevykreslia[1]]) && x != int.Parse(_examArray[_poliaKtoreSaNevykreslia[2]]) && x != int.Parse(_examArray[_poliaKtoreSaNevykreslia[3]]) && x != int.Parse(_examArray[_poliaKtoreSaNevykreslia[4]]))
            {
                moznosti.Add(x);
            }
        }
        ...
        _examArray[pozicia[3]] = _examArray[_poliaKtoreSaNevykreslia[3]];
        _examArray[pozicia[4]] = _examArray[_poliaKtoreSaNevykreslia[4]];
