...
public class LoggedLevel_4_1 : MonoBehaviour, UnityEngine.EventSystems.IHasChanged
{
    ...
    public void draw()
    {
        ...
        GameObject[] _slots = new GameObject[20];
        int y = 1;
        int poc = 0;
        for (int i = 0; i < GameObject.Find("Panel1").gameObject.transform.childCount - 4; i++)
        {
    ...
    void generator_uloh()
    {
        ...
        {
            table_M.Add(SLOT + pocitadloSlotov, null);
            table_M.Add(SLOTM + pocitadloSlotov, num);
