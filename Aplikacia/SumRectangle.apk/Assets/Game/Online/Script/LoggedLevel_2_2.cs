...
public class LoggedLevel_2_2 : MonoBehaviour, UnityEngine.EventSystems.IHasChanged
{
    ...
    public void draw()
    {
        ...
        GameObject[] _slots = new GameObject[13];
        int y = 1;
        int poc = 0;
        for (int i = 0; i < GameObject.Find("Panel1").gameObject.transform.childCount - 4; i++)
        {
    ...
    void generator_uloh()
    {
        ...
        while (_poliaKtoreSaNevykreslia.Count < 4)
        {
        ...
        {
            int x = UnityEngine.Random.Range(1, 30);
