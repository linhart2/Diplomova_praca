...
public class SelectLevelScript : MonoBehaviour
{
	...
	public void StartLevel_1(int value1) //this function will be used on our Play button
    {
		Application.LoadLevel(Random.RandomRange(value1, value1+2)); //this will load our first level from our build settings. "1" is the second scene in our game

    }
	public void EditLevel(int value) //this function will be used on our Play button
    {
