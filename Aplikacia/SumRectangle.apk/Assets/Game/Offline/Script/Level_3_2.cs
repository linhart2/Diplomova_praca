...
public class Level_3_2 : MonoBehaviour, UnityEngine.EventSystems.IHasChanged
{

    public Button reset;
    public GameObject[] itemPrefab; //- prefabsy cisle
    public static List<int> table;    //- zadany priklad
    public static List<int> table_M;  // - zadany priklad + moznosti
    ...
    void generator_uloh()
    {
        ...
        {
            int x = UnityEngine.Random.RandomRange(1, 66);
    ...
    IEnumerator congrats_hide()
    {
        ...
        gratulation.enabled = false;
        Application.LoadLevel(Random.RandomRange(6, 8));
    }
