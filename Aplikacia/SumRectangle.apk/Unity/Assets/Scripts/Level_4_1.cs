...
public class Level_4_1 : MonoBehaviour, UnityEngine.EventSystems.IHasChanged
{
    ...
    public void draw()
    {
        ...
        for (int i = 0; i < GameObject.Find(x + 5).gameObject.transform.childCount; i++)
        {
            slots[i] = GameObject.Find(x + 5).gameObject.transform.GetChild(i).gameObject;
    ...
    IEnumerator congrats_hide()
    {
        ...
        gratulation.enabled = false;
        Application.LoadLevel(UnityEngine.Random.RandomRange(7, 9));
    }
